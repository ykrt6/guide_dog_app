...
class Model(nn.Module):
    ...
    def __call__(self, source=None, stream=False, **kwargs):
        ...
        return self.remodel(source, stream, **kwargs)
    ...
    def premodel(self, predictor=None, **kwargs):
        """
        ...
        return self.predictor, is_cli
    
    def predict(self, predictor, is_cli, source, stream=False):
